...
const StopsPage = () => {
    ...
    const greenStops =[
        ...
        {"name": "Student Health North", "coordinates" : [35.31056565203801, -80.72928365859717]},        {"name:": "CRI Deck", "coordinates" : [35.30938358719176, -80.74409858438285]},
        {"name": "Auxiliary Services", "coordinates" : [35.308045806331585, -80.7303587428002]},
        {"name": "Student Union East", "coordinates" : [35.308060699267486, -80.73274516428042]},
        ...
        <>
            <Col className="p-0 flex-grow-1">
                ...
                >
                    ...
                    />
                    {silverStops.map(x => (
                        <Marker position={[x.coordinates[0], x.coordinates[1]]}>
                            <Popup>
                                {x.name}
                            </Popup>
                        </Marker>
